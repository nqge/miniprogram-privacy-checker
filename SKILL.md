...
version: 2.1
description: 小程序隐私合规检查技能 v2.1 - 检测微信小程序是否符合《微信小程序个人信息保护规范》。用于：(1) 敏感 API 调用检测，(2) 权限声明合规性检查，(3) 数据收集范围分析，(4) 用户授权流程验证，(5) 隐私政策完整性检查，(6) 权限确认单生成⭐，(7) 自评估表生成⭐。触发词：小程序、隐私合规、微信小程序、隐私检查、权限检查、微信隐私、隐私检测、权限检测、API检测、数据安全、小程序审核、合规检查、隐私保护、个人信息保护、微信审核、小程序上线、小程序备案、隐私审查、审核自查、隐私自查、权限申请、敏感信息、个人信息、数据收集、用户授权、隐私政策、隐私条款、权限确认单、自评估表。
---

# 小程序隐私合规检查技能 v2.1

> **最新更新（2026-03-28）**：新增权限确认单生成和自评估表生成功能，详见 [更新历史](#-更新历史)
